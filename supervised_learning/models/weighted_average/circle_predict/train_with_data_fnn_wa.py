...
if __name__ == '__main__':
    model_path = './model/comparison/random0.0/class_obj'
    training_episodes = 80000
    input_dim = 3  # total 280: 0 object index, 1-3 rotation value, 4-6 average contact point position, 7-279 pins positions
    output_dim = 1
    lr=1e-3
    ...
    if args.train:
        data_file=open('compare_data/raw_data00.pickle', "rb")
        ...
        for eps in range(training_episodes):
            ...
            if eps % 100 ==0:
                ...
                plt.savefig('classify_trainwithdataobj0.png')
