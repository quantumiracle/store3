...
class PolicyNetwork(nn.Module):
    ...
    def get_action(self, state, deterministic=True, explore_noise_scale=0.0):
        '''
...
class TD3_Trainer():
    def __init__(self, replay_buffer, state_dim=182, action_dim=2, hidden_dim=128, action_range=20., policy_target_update_interval=1):
